      ...
      <main>
        <div className="content-wrapper">
          ...
          <ol className="order-list">
            ...
            <li>Interrogative Sentences में यदि Simple future का बोध है. तो First और Second Persons ( I और you) इत्यादि के साथ &#39; shall&#39; तथा Third Person (he, she, it, they ) के साथ &#39;will&#39; का प्रयोग होता है (देखो A (c) के वाक्य ) ।</li>
            <li>Interrogative Sentences में यदि इच्छा इत्यादि का बोध हो तो First और Third Persons के साथ &#39; shall &#39; तथा Second Person के साथ &#39;will&#39; का प्रयोग होता है (देखो E के वाक्य ) ।</li>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>वह अपना काम करेगी। </p>
              <p>She will do her work.</p>
            </li>
            <li>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>हम झूठ नहीं बोलेंगे ।</p>
              <p>We shall not tell a lie.</p>
            </li>
            <li>
              <p>वह यहाँ नहीं ठहरेंगा ।</p>
              <p>He will not stay here.</p>
            </li>
            <li>
              <p>वे ऐसा काम नहीं करेंगे।</p>
              <p>They will not do such a thing.</p>
            </li>
            <li>
              <p>वे सैर को नहीं जायेंगे ।</p>
              <p>They will not go for a walk.</p>
            </li>
            <li>
              <p>आप उससे मिलना पसन्द नहीं करेंगे।</p>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>क्या हम यह पुस्तक पढ़ेंगे ?</p>
              <p>Shall we read this book?</p>
            </li>
            <li>
              <p>क्या वे कल आयेंगे ?</p>
              <p>Will they come tomorrow?</p>
            </li>
            <li>
              <p>क्या मैं पास हो जाऊँगा ?</p>
              <p>Shall I get through?</p>
            </li>
            <li>
              <p>क्या तुम कल पन्द्रह वर्ष के हो जाओगे ?</p>
              <p>Will you be fifteen tomorrow?</p>
            </li>
            <li>
              <p>क्या हम दस बजे स्कूल जायेंगे ? </p>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>स्कूल कल बन्द रहेगा । ( आज्ञा )</p>
              <p>The school shall remain closed tomorrow. (Order) </p>
            </li>
            <li>
              <p>राम को यह पारितोषिक मिलेगा ।(वायदा)</p>
              <p>Rama shall get this prize.(Promise)</p>
            </li>
            <li>
              <p>वे तुरन्त ही यहाँ से चले जायेंगे ।  (आज्ञा ) </p>
              <p>They shall leave this place at once. (Order)</p>
            </li>
            <li>
              <p>तुम मेरे आदेश का उल्लंघन नहीं करोगे ।(धमकी)</p>
              <p>You shall not defy my orders.(Threat)</p>
            </li>
            <li>
              <p>उसे दण्ड अवश्य मिलेगा । ( धमकी) </p>
          ...
          <ol className="order-list translate-lines"><li>
            ...
            <li>
              <p>मैं तुम्हें चिड़ियाघर ले जाऊँगा ।</p>
              <p>I will take you to the zoo.</p>
            </li>
            <li>
              <p>मैं अवश्य सफल होऊँगा ।</p>
              <p>I will succeed.</p>
            </li>
            <li>
              <p>मैं इस प्रश्न को अवश्य निकालूँगा ।</p>
              <p>I will solve this sum.</p>
            </li></ol>
          ...
          <li>
            ...
            <li>
              <p>क्या वह जायेगा ? ( इच्छा )</p>
              <p>Shall he go?</p>
            </li>
            <li>
              <p>क्या ( आपकी इच्छा है कि ) मैं यह पुस्तक पढूँ ?</p>
              <p>Shall I read this book?</p>
            </li>
            <li>
              <p>क्या तुम अपने मित्र को देखने नहीं जाओगे ?</p>
              <p>Will you not go to see your friend?</p>
            </li>
            <li>
              <p>क्या तुम इस प्रश्न को नहीं निकालोगे ?</p>
              <p>Will you not solve this sum?</p>
            </li>
            <li>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>वह सायंकाल को घर आयेगा ।</p>
              <p>He is coming home in the evening.</p>
            </li>
            <li>
              <p>हमारी परीक्षा मंगल को होगी।</p>
              <p>Our examination comes off on Tuesday.</p>
            </li>
            <li>
          ...
          <ol className="order-list translate-lines">
            ...
            <li>
              <p>यदि मैं बम्बई जाऊँगा तो तुम्हारे लिए एक कैमरा अवश्य लाऊँगा ।</p>
              <p>If I go to Bombay, I will bring a camera for you.</p>
            </li>
            <li>
              <p>जब तक वह सच नहीं बोलेगा, मैं उससे बात नहीं करूँगा ।</p>
              <p>I shall not talk to him unless he speaks the truth.</p>
            </li>
            <li>
              <p>मैं वहाँ जाऊँगा परन्तु शीघ्र वापस आ जाऊँगा ।</p>
              <p>I shall go there but I shall soon return.</p>
            </li>
            <li>
