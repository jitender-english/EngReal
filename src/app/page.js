      ...
      <main>
        <div className="content-wrapper">
          ...
          <ul>
            ...
            <li>Criminal Record - 
              <Link href="/english/season/criminal-record/s01e01"> <span className="color-dark-secondary">S01E01 </span></Link>
              <Link href="/english/season/criminal-record/s01e02"><span className="color-dark-secondary">S01E02 </span></Link>
            </li>
          </ul>
        </div>
      </main>
